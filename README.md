...
1. Write some code:
	* Create some structures to hold the data stored here: 
		* Trades
		* Price Curves and Type
	* Display the trades:
		* All the trade's attributes
		* The trade's price curve type
		* The Market price (from the price curve data, the 'settle' column) as of Oct 2012
